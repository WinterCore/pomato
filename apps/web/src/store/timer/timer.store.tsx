...
import {ITimerStoreState, TimerStoreActionType, timerStoreReducer} from "../timer/timer.reducer";
import {AudioNotificationType, useAudioNotifications} from "../../hooks/use-audio-notifications";
import TimerWorker from "./timer.worker?worker&inline";
import {IEvent, ISubscriptionEvent} from "./timer.worker";
